## Дан датасет, содержащий информацию об объявлениях на Airbnb в Лондоне. С помощью pandahouse необходимо выгружу нужные данные из ClickHouse и проанализирую их в python. 
### Цель проекта:
